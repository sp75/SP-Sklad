...
public class MoneyToStr
{
  ...
  ""CurrencyList"" : {
    ...
    public MoneyToStr(string currency, string language, string pennies)
    {
        ...
        dynamic currencyList = JsonConvert.DeserializeObject<object>(json); // serializer.Deserialize<object>(json);
        ...
        foreach (var languageItem in items)
        {
            ...
            {
            //    var ff = messages[languageItem["-value"]] = null;
                //var gh = languageItem["-text"].ToString();
                messages.Add(languageItem["-value"].ToString(), languageItem["-text"].ToString().Split(','));
                //messages[languageItem["-value"]] = languageItem["-text"].ToString().Split(',');
            }
        }
     ...
     */
    public string convertValue(decimal theMoney)
    {
