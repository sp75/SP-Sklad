...
namespace SkladData.Models
{
    ...
    public partial class Entities : DbContext
    {
        ...
        [EdmFunction("Entities", "GetDiscount")]
        public virtual IQueryable<GetDiscount_Result> GetDiscount(Nullable<int> ka_id, Nullable<int> mat_id)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<GetDiscount_Result>("[Entities].[GetDiscount](@ka_id, @mat_id)", ka_idParameter, mat_idParameter);
        }
    
        [EdmFunction("Entities", "GetDocList")]
        public virtual IQueryable<GetDocList_Result> GetDocList(Nullable<System.DateTime> from_date, Nullable<System.DateTime> to_date, Nullable<int> ka_id, Nullable<int> w_type)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<GetDocList_Result>("[Entities].[GetDocList](@from_date, @to_date, @ka_id, @w_type)", from_dateParameter, to_dateParameter, ka_idParameter, w_typeParameter);
        }
    
        [EdmFunction("Entities", "GetListMatPrices")]
        public virtual IQueryable<GetListMatPrices_Result> GetListMatPrices(Nullable<int> mat_id, Nullable<int> in_curr_id, Nullable<int> p_type)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<GetListMatPrices_Result>("[Entities].[GetListMatPrices](@mat_id, @in_curr_id, @p_type)", mat_idParameter, in_curr_idParameter, p_typeParameter);
        }
    
        [EdmFunction("Entities", "GetMakeAmount")]
        public virtual IQueryable<GetMakeAmount_Result> GetMakeAmount(Nullable<int> wbill_id)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<GetMakeAmount_Result>("[Entities].[GetMakeAmount](@wbill_id)", wbill_idParameter);
        }
    
        [EdmFunction("Entities", "GetMatChange")]
        public virtual IQueryable<GetMatChange_Result> GetMatChange(Nullable<int> mat_id)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<GetMatChange_Result>("[Entities].[GetMatChange](@mat_id)", mat_idParameter);
        }
    
        [EdmFunction("Entities", "GetMatExtra")]
        public virtual IQueryable<GetMatExtra_Result> GetMatExtra(Nullable<int> matId, Nullable<int> pTypeId, Nullable<System.DateTime> onDate, Nullable<decimal> price, Nullable<int> in_CurrId, Nullable<decimal> onValue)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<GetMatExtra_Result>("[Entities].[GetMatExtra](@MatId, @PTypeId, @OnDate, @Price, @in_CurrId, @OnValue)", matIdParameter, pTypeIdParameter, onDateParameter, priceParameter, in_CurrIdParameter, onValueParameter);
        }
    
        [EdmFunction("Entities", "GetMatGroupTree")]
        public virtual IQueryable<GetMatGroupTree_Result> GetMatGroupTree(Nullable<int> root_cat_id)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<GetMatGroupTree_Result>("[Entities].[GetMatGroupTree](@root_cat_id)", root_cat_idParameter);
        }
    
        [EdmFunction("Entities", "GetMatMove")]
        public virtual IQueryable<GetMatMove_Result> GetMatMove(Nullable<int> mat_id, Nullable<System.DateTime> from_date, Nullable<System.DateTime> to_date, Nullable<int> wid, Nullable<int> ka_id, Nullable<int> w_type, string wh)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<GetMatMove_Result>("[Entities].[GetMatMove](@mat_id, @from_date, @to_date, @wid, @ka_id, @w_type, @wh)", mat_idParameter, from_dateParameter, to_dateParameter, widParameter, ka_idParameter, w_typeParameter, whParameter);
        }
    
        [EdmFunction("Entities", "GetMatPriceTypes")]
        public virtual IQueryable<GetMatPriceTypes_Result> GetMatPriceTypes(Nullable<int> mat_id)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<GetMatPriceTypes_Result>("[Entities].[GetMatPriceTypes](@mat_id)", mat_idParameter);
        }
    
        [EdmFunction("Entities", "GetMatRsv")]
        public virtual IQueryable<GetMatRsv_Result> GetMatRsv(Nullable<int> mat_id, Nullable<int> ka_id, Nullable<System.DateTime> from_date, Nullable<System.DateTime> to_date, Nullable<int> w_type)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<GetMatRsv_Result>("[Entities].[GetMatRsv](@mat_id, @ka_id, @from_date, @to_date, @w_type)", mat_idParameter, ka_idParameter, from_dateParameter, to_dateParameter, w_typeParameter);
        }
    
        [EdmFunction("Entities", "GetOperLog")]
        public virtual IQueryable<GetOperLog_Result> GetOperLog(Nullable<System.DateTime> from_date, Nullable<System.DateTime> to_date, Nullable<int> fun_id, Nullable<int> user_id)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<GetOperLog_Result>("[Entities].[GetOperLog](@from_date, @to_date, @fun_id, @user_id)", from_dateParameter, to_dateParameter, fun_idParameter, user_idParameter);
        }
    
        [EdmFunction("Entities", "GetOrdered")]
        public virtual IQueryable<GetOrdered_Result> GetOrdered(Nullable<int> mat_id, Nullable<int> wid, Nullable<int> ka_id, Nullable<System.DateTime> on_date, Nullable<int> get_empty, string wh)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<GetOrdered_Result>("[Entities].[GetOrdered](@mat_id, @wid, @ka_id, @on_date, @get_empty, @wh)", mat_idParameter, widParameter, ka_idParameter, on_dateParameter, get_emptyParameter, whParameter);
        }
    
        [EdmFunction("Entities", "GetPosIn")]
        public virtual IQueryable<GetPosIn_Result> GetPosIn(Nullable<System.DateTime> on_data, Nullable<int> mat_id, Nullable<int> wid, Nullable<int> ka_id)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<GetPosIn_Result>("[Entities].[GetPosIn](@on_data, @mat_id, @wid, @ka_id)", on_dataParameter, mat_idParameter, widParameter, ka_idParameter);
        }
    
        [EdmFunction("Entities", "GetPrintLog")]
        public virtual IQueryable<GetPrintLog_Result> GetPrintLog(Nullable<System.DateTime> from_date, Nullable<System.DateTime> to_date, Nullable<int> user_id)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<GetPrintLog_Result>("[Entities].[GetPrintLog](@from_date, @to_date, @user_id)", from_dateParameter, to_dateParameter, user_idParameter);
        }
    
        [EdmFunction("Entities", "GetRelDocList")]
        public virtual IQueryable<GetRelDocList_Result> GetRelDocList(Nullable<int> doc_id)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<GetRelDocList_Result>("[Entities].[GetRelDocList](@doc_id)", doc_idParameter);
        }
    
        [EdmFunction("Entities", "GetSvcGroupTree")]
        public virtual IQueryable<GetSvcGroupTree_Result> GetSvcGroupTree(Nullable<int> root_cat_id)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<GetSvcGroupTree_Result>("[Entities].[GetSvcGroupTree](@root_cat_id)", root_cat_idParameter);
        }
    
        [EdmFunction("Entities", "GetWaybillDetIn")]
        public virtual IQueryable<GetWaybillDetIn_Result> GetWaybillDetIn(Nullable<int> wbill_id)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<GetWaybillDetIn_Result>("[Entities].[GetWaybillDetIn](@wbill_id)", wbill_idParameter);
        }
    
        [EdmFunction("Entities", "GetWayBillDetOut")]
        public virtual IQueryable<GetWayBillDetOut_Result> GetWayBillDetOut(Nullable<int> wbill_id)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<GetWayBillDetOut_Result>("[Entities].[GetWayBillDetOut](@wbill_id)", wbill_idParameter);
        }
    
        [EdmFunction("Entities", "GetWayBillList")]
        ...
        public virtual IQueryable<GetWayBillListWh_Result> GetWayBillListWh(Nullable<System.DateTime> from_date, Nullable<System.DateTime> to_date, Nullable<int> w_type, Nullable<int> is_checked, string wh)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<GetWayBillListWh_Result>("[Entities].[GetWayBillListWh](@from_date, @to_date, @w_type, @is_checked, @wh)", from_dateParameter, to_dateParameter, w_typeParameter, is_checkedParameter, whParameter);
        }
    
        [EdmFunction("Entities", "MatRemainByWh")]
        public virtual IQueryable<MatRemainByWh_Result> MatRemainByWh(Nullable<int> mat_id, Nullable<int> w_id, Nullable<int> ka_id, Nullable<System.DateTime> on_date, string wh)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<MatRemainByWh_Result>("[Entities].[MatRemainByWh](@mat_id, @w_id, @ka_id, @on_date, @wh)", mat_idParameter, w_idParameter, ka_idParameter, on_dateParameter, whParameter);
        }
    
        [EdmFunction("Entities", "MoneyMoveList")]
        public virtual IQueryable<MoneyMoveList_Result> MoneyMoveList(Nullable<int> doc_type, Nullable<System.DateTime> from_date, Nullable<System.DateTime> to_date, Nullable<int> is_checked)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<MoneyMoveList_Result>("[Entities].[MoneyMoveList](@doc_type, @from_date, @to_date, @is_checked)", doc_typeParameter, from_dateParameter, to_dateParameter, is_checkedParameter);
        }
    
        [EdmFunction("Entities", "MoneyOnDate")]
        public virtual IQueryable<MoneyOnDate_Result> MoneyOnDate(Nullable<System.DateTime> on_date)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<MoneyOnDate_Result>("[Entities].[MoneyOnDate](@on_date)", on_dateParameter);
        }
    
        [EdmFunction("Entities", "MoneyTurnover")]
        public virtual IQueryable<MoneyTurnover_Result> MoneyTurnover(Nullable<int> fun_id, Nullable<System.DateTime> from_date, Nullable<System.DateTime> to_date, Nullable<int> turn_type, Nullable<int> curr_id, Nullable<int> ka_id)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<MoneyTurnover_Result>("[Entities].[MoneyTurnover](@fun_id, @from_date, @to_date, @turn_type, @curr_id, @ka_id)", fun_idParameter, from_dateParameter, to_dateParameter, turn_typeParameter, curr_idParameter, ka_idParameter);
        }
    
        [EdmFunction("Entities", "OrderedList")]
        public virtual IQueryable<OrderedList_Result> OrderedList(Nullable<System.DateTime> from_date, Nullable<System.DateTime> to_date, Nullable<int> mat_id, Nullable<int> ka_id, Nullable<int> w_type, Nullable<int> active)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<OrderedList_Result>("[Entities].[OrderedList](@from_date, @to_date, @mat_id, @ka_id, @w_type, @active)", from_dateParameter, to_dateParameter, mat_idParameter, ka_idParameter, w_typeParameter, activeParameter);
        }
    
        [EdmFunction("Entities", "PosGet")]
        public virtual IQueryable<PosGet_Result> PosGet(Nullable<int> mat_id, Nullable<int> w_id, Nullable<int> ka_id, Nullable<System.DateTime> on_date, Nullable<int> get_empty, string wh)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<PosGet_Result>("[Entities].[PosGet](@mat_id, @w_id, @ka_id, @on_date, @get_empty, @wh)", mat_idParameter, w_idParameter, ka_idParameter, on_dateParameter, get_emptyParameter, whParameter);
        }
    
        [EdmFunction("Entities", "REP_10")]
        public virtual IQueryable<REP_10_Result> REP_10(Nullable<System.DateTime> from_date, Nullable<System.DateTime> to_date, Nullable<int> grp_id, string wh, Nullable<int> show_all_mat)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<REP_10_Result>("[Entities].[REP_10](@from_date, @to_date, @grp_id, @wh, @show_all_mat)", from_dateParameter, to_dateParameter, grp_idParameter, whParameter, show_all_matParameter);
        }
    
        [EdmFunction("Entities", "REP_13")]
        public virtual IQueryable<REP_13_Result> REP_13(Nullable<System.DateTime> from_date, Nullable<System.DateTime> to_date, Nullable<int> grp_id, Nullable<int> ka_id, string wh, Nullable<int> only_return)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<REP_13_Result>("[Entities].[REP_13](@from_date, @to_date, @grp_id, @ka_id, @wh, @only_return)", from_dateParameter, to_dateParameter, grp_idParameter, ka_idParameter, whParameter, only_returnParameter);
        }
    
        [EdmFunction("Entities", "REP_16")]
        public virtual IQueryable<REP_16_Result> REP_16(Nullable<System.DateTime> from_date, Nullable<System.DateTime> to_date, Nullable<int> ka_id, Nullable<int> ctype, Nullable<int> showall)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<REP_16_Result>("[Entities].[REP_16](@from_date, @to_date, @ka_id, @ctype, @showall)", from_dateParameter, to_dateParameter, ka_idParameter, ctypeParameter, showallParameter);
        }
    
        [EdmFunction("Entities", "REP_17")]
        public virtual IQueryable<REP_17_Result> REP_17(Nullable<System.DateTime> from_date, Nullable<System.DateTime> to_date, Nullable<int> grp_id, Nullable<int> ka_id)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<REP_17_Result>("[Entities].[REP_17](@from_date, @to_date, @grp_id, @ka_id)", from_dateParameter, to_dateParameter, grp_idParameter, ka_idParameter);
        }
    
        [EdmFunction("Entities", "REP_20")]
        public virtual IQueryable<REP_20_Result> REP_20(Nullable<System.DateTime> from_date, Nullable<System.DateTime> to_date, Nullable<int> grp_id, Nullable<int> ka_id)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<REP_20_Result>("[Entities].[REP_20](@from_date, @to_date, @grp_id, @ka_id)", from_dateParameter, to_dateParameter, grp_idParameter, ka_idParameter);
        }
    
        [EdmFunction("Entities", "REP_27")]
        public virtual IQueryable<REP_27_Result> REP_27(Nullable<System.DateTime> from_date, Nullable<System.DateTime> to_date, Nullable<int> ka_id, Nullable<int> grp_id, Nullable<int> mat_id)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<REP_27_Result>("[Entities].[REP_27](@from_date, @to_date, @ka_id, @grp_id, @mat_id)", from_dateParameter, to_dateParameter, ka_idParameter, grp_idParameter, mat_idParameter);
        }
    
        [EdmFunction("Entities", "REP_29")]
        public virtual IQueryable<REP_29_Result> REP_29(Nullable<System.DateTime> from_date, Nullable<System.DateTime> to_date, Nullable<int> ka_id, Nullable<int> grp_id, string wh)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<REP_29_Result>("[Entities].[REP_29](@from_date, @to_date, @ka_id, @grp_id, @wh)", from_dateParameter, to_dateParameter, ka_idParameter, grp_idParameter, whParameter);
        }
    
        [EdmFunction("Entities", "REP_31")]
        public virtual IQueryable<REP_31_Result> REP_31(Nullable<System.DateTime> from_date, Nullable<System.DateTime> to_date, Nullable<int> grp_id, Nullable<int> mat_id)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<REP_31_Result>("[Entities].[REP_31](@from_date, @to_date, @grp_id, @mat_id)", from_dateParameter, to_dateParameter, grp_idParameter, mat_idParameter);
        }
    
        [EdmFunction("Entities", "SP_AUTO_RSV_WB_2")]
        public virtual IQueryable<SP_AUTO_RSV_WB_2_Result> SP_AUTO_RSV_WB_2(Nullable<int> wBILLID)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<SP_AUTO_RSV_WB_2_Result>("[Entities].[SP_AUTO_RSV_WB_2](@WBILLID)", wBILLIDParameter);
        }
    
        [EdmFunction("Entities", "SP_CONTRACTS_LIST")]
        public virtual IQueryable<SP_CONTRACTS_LIST_Result> SP_CONTRACTS_LIST(Nullable<int> iN_DOCTYPE, Nullable<System.DateTime> iN_FROMDATE, Nullable<System.DateTime> iN_TODATE, Nullable<int> iN_KAID, Nullable<int> iN_CHECKED)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<SP_CONTRACTS_LIST_Result>("[Entities].[SP_CONTRACTS_LIST](@IN_DOCTYPE, @IN_FROMDATE, @IN_TODATE, @IN_KAID, @IN_CHECKED)", iN_DOCTYPEParameter, iN_FROMDATEParameter, iN_TODATEParameter, iN_KAIDParameter, iN_CHECKEDParameter);
        }
    
        [EdmFunction("Entities", "SP_GET_ACTIVES")]
        public virtual IQueryable<SP_GET_ACTIVES_Result> SP_GET_ACTIVES(Nullable<System.DateTime> fROMDATE, Nullable<System.DateTime> tODATE)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<SP_GET_ACTIVES_Result>("[Entities].[SP_GET_ACTIVES](@FROMDATE, @TODATE)", fROMDATEParameter, tODATEParameter);
        }
    
        [EdmFunction("Entities", "SP_GET_AVG_PRICE")]
        public virtual IQueryable<SP_GET_AVG_PRICE_Result> SP_GET_AVG_PRICE(Nullable<int> iN_POSID)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<SP_GET_AVG_PRICE_Result>("[Entities].[SP_GET_AVG_PRICE](@IN_POSID)", iN_POSIDParameter);
        }
    
        [EdmFunction("Entities", "SP_GET_MAT_NDS")]
        public virtual IQueryable<SP_GET_MAT_NDS_Result> SP_GET_MAT_NDS(Nullable<int> mATID)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<SP_GET_MAT_NDS_Result>("[Entities].[SP_GET_MAT_NDS](@MATID)", mATIDParameter);
        }
    
        [EdmFunction("Entities", "SP_GET_MATGRP_NDS")]
        public virtual IQueryable<SP_GET_MATGRP_NDS_Result> SP_GET_MATGRP_NDS(Nullable<int> gRPID)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<SP_GET_MATGRP_NDS_Result>("[Entities].[SP_GET_MATGRP_NDS](@GRPID)", gRPIDParameter);
        }
    
        [EdmFunction("Entities", "SP_GET_RELDOCIDS")]
        public virtual IQueryable<SP_GET_RELDOCIDS_Result> SP_GET_RELDOCIDS(Nullable<int> aDOCID)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<SP_GET_RELDOCIDS_Result>("[Entities].[SP_GET_RELDOCIDS](@ADOCID)", aDOCIDParameter);
        }
    
        [EdmFunction("Entities", "SP_MAT_REMAIN_GET_SIMPLE")]
        public virtual IQueryable<SP_MAT_REMAIN_GET_SIMPLE_Result> SP_MAT_REMAIN_GET_SIMPLE(Nullable<int> matId, Nullable<System.DateTime> onDate)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<SP_MAT_REMAIN_GET_SIMPLE_Result>("[Entities].[SP_MAT_REMAIN_GET_SIMPLE](@MatId, @OnDate)", matIdParameter, onDateParameter);
        }
    
        [EdmFunction("Entities", "SP_MATCHANGE_GET_WP")]
        public virtual IQueryable<SP_MATCHANGE_GET_WP_Result> SP_MATCHANGE_GET_WP(Nullable<int> mATID, Nullable<System.DateTime> mCDATE)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<SP_MATCHANGE_GET_WP_Result>("[Entities].[SP_MATCHANGE_GET_WP](@MATID, @MCDATE)", mATIDParameter, mCDATEParameter);
        }
    
        [EdmFunction("Entities", "SP_WMAT_GET_BY_WHLIST")]
        public virtual IQueryable<SP_WMAT_GET_BY_WHLIST_Result> SP_WMAT_GET_BY_WHLIST(Nullable<int> iN_MATID, Nullable<System.DateTime> oNDATE, string wH)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<SP_WMAT_GET_BY_WHLIST_Result>("[Entities].[SP_WMAT_GET_BY_WHLIST](@IN_MATID, @ONDATE, @WH)", iN_MATIDParameter, oNDATEParameter, wHParameter);
        }
        ...
        public virtual IQueryable<Split_Result> Split(string sep, string s)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<Split_Result>("[Entities].[Split](@sep, @s)", sepParameter, sParameter);
        }
    
        [EdmFunction("Entities", "WBDGetOutP2")]
        public virtual IQueryable<WBDGetOutP2_Result> WBDGetOutP2(Nullable<int> wbill_id)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<WBDGetOutP2_Result>("[Entities].[WBDGetOutP2](@wbill_id)", wbill_idParameter);
        }
    
        [EdmFunction("Entities", "WhMatGet")]
        public virtual IQueryable<WhMatGet_Result> WhMatGet(Nullable<int> grp_id, Nullable<int> wid, Nullable<int> ka_id, Nullable<System.DateTime> on_date, Nullable<int> get_empty, string wh, Nullable<int> show_all_mats, string grp, Nullable<int> user_id, Nullable<int> get_child_node)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<WhMatGet_Result>("[Entities].[WhMatGet](@grp_id, @wid, @ka_id, @on_date, @get_empty, @wh, @show_all_mats, @grp, @user_id, @get_child_node)", grp_idParameter, widParameter, ka_idParameter, on_dateParameter, get_emptyParameter, whParameter, show_all_matsParameter, grpParameter, user_idParameter, get_child_nodeParameter);
        }
