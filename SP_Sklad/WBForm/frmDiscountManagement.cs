...
{
    public partial class frmDiscountManagement : DevExpress.XtraEditors.XtraForm
    {
        ...
        public frmDiscountManagement(Guid? wbt_id = null)
        {
            InitializeComponent();
        ...
        private void frmPriceList_Load(object sender, EventArgs e)
        {
            ...
            if (wbt != null)
            {
                DiscountManagementBS.DataSource = wbt;
            }
