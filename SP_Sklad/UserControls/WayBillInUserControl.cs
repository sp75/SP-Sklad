...
namespace SP_Sklad.UserControls
{
    public partial class WayBillInUserControl : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        private void WayBillInSource_GetQueryable(object sender, DevExpress.Data.Linq.GetQueryableEventArgs e)
        {
            ...
            var list = objectContext.v_WayBillIn.Where(w => w.OnDate > satrt_date && w.OnDate <= end_date && (w.Checked == status || status == -1) && (w.KaId == kagent_id || kagent_id == 0) && w.WorkerId == DBHelper.CurrentUser.KaId);
