...
{
    public partial class ucWayBillSupplierOrders : DevExpress.XtraEditors.XtraUserControl
    {
        int w_type = 16;
        private int fun_id = 65;
        private string reg_layout_path = "ucWayBillSupplierOrders\\WbInGridView";
        ...
        public ucWayBillSupplierOrders()
        {
            InitializeComponent();
        }
        ...
        public void CopyItem()
        {
            ...
            using (var wb_in = new frmWayBillIn(w_type, doc.out_wbill_id))
            {
        ...
        public void DeleteItem()
        {
            ...
            if (XtraMessageBox.Show($"Ви дійсно бажаєте видалити замовлення постачальнику {wb_focused_row.Num}?", "Видалення документа", MessageBoxButtons.YesNo, MessageBoxIcon.Information) == DialogResult.Yes)
            {
