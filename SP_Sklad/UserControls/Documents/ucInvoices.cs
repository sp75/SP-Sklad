...
{
    public partial class ucInvoices : DevExpress.XtraEditors.XtraUserControl
    {
        int w_type = 2;
        private int fun_id = 30;
        private string reg_layout_path = "ucInvoices\\WbInGridView";
        ...
        public void DeleteItem()
        {
            ...
            if (XtraMessageBox.Show($"Ви дійсно бажаєте видалити рахунок {wb_focused_row.Num}?", "Видалення документа", MessageBoxButtons.YesNo, MessageBoxIcon.Information) == DialogResult.Yes)
            {
        ...
        private void SetWBEditorBarBtn()
        {
            ...
            EditItemBtn.Enabled = (wb_focused_row != null && wb_focused_row.Checked == 0 && user_access.CanModify == 1);
        ...
        private void xtraTabControl2_SelectedPageChanged(object sender, DevExpress.XtraTab.TabPageChangedEventArgs e)
        {
            ...
            switch (xtraTabControl2.SelectedTabPageIndex)
            {
                ...
                case 1:
                    vGridControl1.DataSource = new BaseEntities().v_Invoices.AsNoTracking().Where(w => w.WbillId == wb_focused_row.WbillId && w.WorkerId == DBHelper.CurrentUser.KaId).ToList();
                    break;
