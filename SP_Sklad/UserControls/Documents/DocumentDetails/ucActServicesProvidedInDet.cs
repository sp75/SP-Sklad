...
{
    public partial class ucActServicesProvidedInDet : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public ucActServicesProvidedInDet()
        {
            InitializeComponent();
        }
        ...
        public void GetDate(int wbill_id)
        {
            ...
            var list = new BaseEntities().v_WayBillInDet.Where(w => w.WbillId == wbill_id).OrderBy(o => o.Num).ToList();
