...
namespace SP_Sklad.UserControls
{
    ...
    {
        int w_type = -6;
        private int fun_id = 43;
        private string reg_layout_path = "ucWaybillReturnSuppliers\\WbInGridView";
        ...
        public void DeleteItem()
        {
            ...
            if (XtraMessageBox.Show($"Ви дійсно бажаєте видалити повернення постачальнику {wb_focused_row.Num}?", "Видалення документа", MessageBoxButtons.YesNo, MessageBoxIcon.Information) == DialogResult.Yes)
            {
        ...
        private void xtraTabControl2_SelectedPageChanged(object sender, DevExpress.XtraTab.TabPageChangedEventArgs e)
        {
            ...
            switch (xtraTabControl2.SelectedTabPageIndex)
            {
                ...
                case 1:
                    vGridControl1.DataSource = new BaseEntities().v_WayBillReturnSuppliers.AsNoTracking().Where(w => w.WbillId == wb_focused_row.WbillId && w.WorkerId == DBHelper.CurrentUser.KaId).ToList();
                    break;
