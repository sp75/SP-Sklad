...
namespace SP_Sklad.UserControls
{
    public partial class ucWaybillMove : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public void DeleteItem()
        {
            ...
            if (XtraMessageBox.Show($"Ви дійсно бажаєте видалити накладну переміщення{wb_focused_row.Num}?", "Видалення документа", MessageBoxButtons.YesNo, MessageBoxIcon.Information) == DialogResult.Yes)
            {
