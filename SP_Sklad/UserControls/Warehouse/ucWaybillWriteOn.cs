...
namespace SP_Sklad.UserControls
{
    public partial class ucWaybillWriteOn : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public void DeleteItem()
        {
            ...
            if (XtraMessageBox.Show($"Ви дійсно бажаєте видалити введення залишків{wb_focused_row.Num}?", "Видалення документа", MessageBoxButtons.YesNo, MessageBoxIcon.Information) == DialogResult.Yes)
            {
