...
namespace SP_Sklad.UserControls
{
    public partial class ucWaybillWriteOff : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public void DeleteItem()
        {
            ...
            if (XtraMessageBox.Show($"Ви дійсно бажаєте видалити акт списання товару №{wb_focused_row.Num}?", "Видалення документа", MessageBoxButtons.YesNo, MessageBoxIcon.Information) == DialogResult.Yes)
            {
        ...
        private void xtraTabControl2_SelectedPageChanged(object sender, DevExpress.XtraTab.TabPageChangedEventArgs e)
        {
            ...
            switch (xtraTabControl2.SelectedTabPageIndex)
            {
                ...
                case 1:
                    vGridControl1.DataSource = new BaseEntities().v_WaybillWriteOff.AsNoTracking().Where(w => w.WbillId == wb_focused_row.WbillId && w.WorkerId == DBHelper.CurrentUser.KaId).ToList();
                    break;
