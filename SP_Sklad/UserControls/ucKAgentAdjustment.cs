...
namespace SP_Sklad.UserControls
{
    public partial class ucKAgentAdjustment : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        private void ucProjectManagement_Load(object sender, EventArgs e)
        {
            ...
            KAgentAdjustmentGridView.RestoreLayoutFromRegistry(IHelper.reg_layout_path + "ucKAgentAdjustment\\KAgentAdjustmentGridView");
        ...
        public void NewItem()
        {
            using (var frm = new frmKAgentAdjustment())
            {
                frm.ShowDialog();
            }
        }
        ...
        public void EditItem()
        {
            ...
            using (var frm = new frmKAgentAdjustment(focused_row.Id))
            {
                frm.ShowDialog();
            }
        }
        ...
        public void GetData()
        {
            ...
            KAgentAdjustmentGridControl.DataSource = KAgentAdjustmentSource;
        ...
        {
            KAgentAdjustmentGridView.SaveLayoutToRegistry(IHelper.reg_layout_path + "ucKAgentAdjustment\\KAgentAdjustmentGridView");
        }
        ...
        private void KAgentAdjustmentSource_GetQueryable(object sender, DevExpress.Data.Linq.GetQueryableEventArgs e)
        {
            ...
            var list = objectContext.v_KAgentAdjustment.Where(w => w.OnDate >= satrt_date && w.OnDate <= end_date && (status == -1 || w.Checked == status));
        ...
        private void xtraTabControl4_SelectedPageChanged(object sender, DevExpress.XtraTab.TabPageChangedEventArgs e)
        {
            ...
            switch (xtraTabControl4.SelectedTabPageIndex)
            {
                ...
                case 1:
                    vGridControl3.DataSource = focused_row;
                    break;
